...
public class Genetics
{
    ...
    public static void Evolution(int maxGenerations, int simulationsPerGeneration, 
        double misspellingRate, Func<int, int, int, Task> updateDelegate = null)
    {
        var rootStrategy = new ChutesAndLadders.Strategy.Genetic.Engine("LinearGenome");
        rootStrategy.LoadLinearGenome();

        var players = new PlayerCollectionBuilder()
            .Add("Player 1", rootStrategy.Evolve(misspellingRate))
            .Add("Player 2", rootStrategy.Evolve(misspellingRate))
            .Add("Player 3", rootStrategy.Evolve(misspellingRate))
            .Add("Player 4", rootStrategy.Evolve(misspellingRate))
            .Add("Player 5", rootStrategy.Evolve(misspellingRate))
            .Add("Player 6", rootStrategy)
            .Build();
        ...
        new SimulationCollectionBuilder()
            .AddPlayer("Player 1", rootStrategy)
            .AddPlayer("Player 2", finalStrategy)
            .AddPlayer("Player 3", rootStrategy)
            .AddPlayer("Player 4", finalStrategy)
            .AddPlayer("Player 5", rootStrategy)
            .AddPlayer("Player 6", finalStrategy)
