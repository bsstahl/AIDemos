...
namespace Scheduler.Web
{
    public class Optimizer
    {
        ...
        public void Schedule()
        {
            ...
            var engine = new ConferenceScheduler.Optimizer.Glop.Engine(this.EngineUpdateEventHandler, disableTrace);
            ...
            var presenterUnfavoredTimeslots = new List<Tuple<Presenter, int>>
            {
                ...
                // Prefers the last 2 sessions of the day
                { presenterMaxNodland, 1 },
                { presenterMaxNodland, 2 },

                // Doesn't like morning sessions
                { presenterBarryStahl, 1 },
                { presenterBarryStahl, 2 },

                // Doesn't like 1st session of morning & afternoon
                { presenterJustineCocci, 1 },
                { presenterJustineCocci, 3 },

                // Prefers 1st session of the day
                { presenterChrisGriffith, 2 },
                { presenterChrisGriffith, 3 },
                { presenterChrisGriffith, 4 }
            };
